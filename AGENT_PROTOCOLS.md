...
| ACP discovery | `/.well-known/acp.json` | The [Agentic Commerce Protocol discovery proposal](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol/blob/main/rfcs/rfc.discovery.md) defines a public seller-capability document and explicitly excludes sensitive or seller-specific data. |
